...
shopt -s progcomp
complete -F _comp setup -?
complete -F _comp setup -h
complete -F _comp setup --help
complete -F _comp setup -v
complete -F _comp setup --version
complete -F _comp setup help
complete -F _comp setup version
complete -F _comp setup alias
complete -F _comp setup defaults
complete -F _comp setup functions
complete -F _comp setup paths
complete -F _comp setup profile
